...
@RestApi(baseUrl: "http://10.0.2.2:8001/api/user/")
abstract class RetrofitClient {
  ...
  @POST("deletecartitem")
  Future<CartResponse> cartitemdelete(@Body() CartItemDeleteRequest cartItemDeleteRequest);

  @GET("getsinglesubcategory?id={id}")
  Future<ProductDetailsResponse> getProductdetails(@Path("id") String postId);

  @POST("forgotpassword")
  Future<LoginResponse> requestForgotpassword(@Body() ForgotPasswordRequest forgotPasswordRequest);

  @PATCH("verifyotp")
  Future<LoginResponse> requestOtpverify(@Body() OtpVerifyRequest otpVerifyRequest);

  @PATCH("resetPassword")
  Future<LoginResponse> requestResetPassword(@Body() ResetPasswordRequest resetpasswordrequest);

  @POST("placeOrder")
  Future<PlaceorderResponse> requestPlaceorder(@Body() PlaceOrderRequest placeOrderRequest);

  @GET("myorders")
  Future<GetOrderResponse> getorder();

  @PATCH("changepassword")
  Future<LoginResponse> requestChangePassword(@Body() ChangepasswordRequest changepasswordRequest);
